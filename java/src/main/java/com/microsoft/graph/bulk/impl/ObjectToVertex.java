...
public final class ObjectToVertex {
    ...
    public static GremlinVertex toGremlinVertex(Object from) {
        Class<?> clazz = from.getClass();

        var results = GremlinVertex.builder()
     ...
     */
    private static void setLabelFromClass(Class<?> clazz, GremlinVertex results) {
     ...
     */
    @SneakyThrows
    private static void setFieldValues(Class<?> clazz, GremlinVertex results, Object from) {
     ...
     */
    private static void setIdValue(Field field, GremlinVertex results, Object from)
     ...
     * @throws IllegalAccessException When the field is not accessible from this utility
     */
    private static void setPartitionKey(Field field, GremlinVertex results, Object from)
            throws IllegalAccessException {
        ...
        if (field.isAnnotationPresent(pkAnnotationClass)) {
            ...
            var pk = new com.microsoft.graph.bulk.impl.model.GremlinPartitionKey(
     ...
     * @throws IllegalAccessException When the field is not accessible from this utility
     */
    private static void setLabel(Field field, GremlinVertex results, Object from) throws IllegalAccessException {
     ...
     */
    private static void setLabelFromGetter(Class<?> clazz, GremlinVertex results, Object from)
     ...
     * @throws IllegalAccessException When the field is not accessible from this utility
     */
    private static void setPropertyMap(Field field, GremlinVertex results, Object from) throws IllegalAccessException {
     ...
     * @throws IllegalAccessException When the field is not accessible from this utility
     */
    private static void setPropertyValues(Field field, GremlinVertex results, Object from)
            throws IllegalAccessException {
